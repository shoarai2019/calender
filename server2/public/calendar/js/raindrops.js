...
$.widget("water.raindrops", {
    ...
    renderWaves: function ()
    {
        ...
        for (i = 0; i < this.options.waveLength; i++)
        {
            this.ctx.lineTo(i * (this.options.realWidth / this.options.waveLength), (waterHeight / 2) + this.springs[i].p);
        }
        this.ctx.lineTo(this.options.realWidth, waterHeight);
        this.ctx.fill();
    } 
...
function raindropsAnimationTick(drop) {
    ...
    drop.ctx.clearRect(0, 0, drop.options.realWidth, waterHeight);
